...
module.exports = {
    ...
    ac_abbr: 'AC',
    armor: 'armor | armor',
    armor_item_subtitle: '{rarity} {armorType}',
    armor_placements: {
        head: 'head',
        head_title: 'Head',
        chest: 'chest',
    ...
    armor_types: {
        ...
        shield_armor: 'shield',
        any_armor: '',
        any_medium_armor: 'medium armor',
        any_heavy_armor: 'heavy armor',
        specific_armor: 'specific armor',
        heavy_armor_title: 'Heavy Armor',
        light_armor_title: 'Light Armor',
        medium_armor_title: 'Medium Armor',
        shield_armor_title: 'Shield',
        any_armor_title: '',
        any_medium_armor_title: 'Medium Armor',
        any_heavy_armor_title: 'Heavy Armor',
        specific_armor_title: 'Specific Armor',
    },
    assets_title: 'Assets',
    assetspage,
    attack_title: 'Attack',
